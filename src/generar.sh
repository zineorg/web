...
for f in ../microphone1/*.md; do pandoc "$f" --toc --toc-depth=3 --template plantilla.html -c /src/style.css -B menu-en.html -A pie-en.html -o "../microphone2/$(basename "${f%.*}").html"; done
